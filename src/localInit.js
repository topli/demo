...
const data = {
  ...
  tasks: {
    list: [
      ...
      { id: 2, no: 'BJ201905231530', goods: '煤矿', totalQuqntity: '1.0', dispatchNo: 'ZGBJLT022019060602', devices: '91270313(石敏),41080622(吕勇),41086687(高涛)', workTime: '35H', progress: 80, name: '工程2', status: '已调度', executor: '白杰', line: '天安门-中关村', describe: '运输', orgId: '1', orgName: '山西分公司', enclosure: '中关村附近', level: 2, receiving: '武汉分公司', receivingMode: '货运', receivingPerson: '宋春梅', receivingPhone: '13344554565', isRemind: 2, expiryDate: ['2019-06-09T16:00:00.000Z', '2019-06-12T16:00:00.000Z'], deviceTypeNum: '运输车（3台）' },
      { id: 3, no: 'BJ201905231531', goods: '渣土', totalQuqntity: '2.0', dispatchNo: 'ZGBJLT032019060603', devices: '91207390(沈明),41108559(方静),41108584(石洋)', workTime: '31H', progress: 89, name: '工程3', status: '未调度', executor: '贾刚', line: '朝阳区-中关村', describe: '运输', orgId: '1', orgName: '山西分公司', enclosure: '中关村附近', level: 3, receiving: '武汉分公司', receivingMode: '货运', receivingPerson: '李世杰', receivingPhone: '13232903465', isRemind: 1, expiryDate: ['2019-06-11T16:00:00.000Z', '2019-06-15T16:00:00.000Z'], deviceTypeNum: '运输车（3台）' }
    ]
  },
  currentTaskReport: {
    list: [
