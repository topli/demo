...
<template>
  ...
  <Poptip v-else v-model="showPoptip" style="width: 100%;" placement="bottom-start">
    <Input ref="pId" v-model="inStr" @on-focus="handlerFocus" @on-blur="handlerBlur" clearable  @on-change="handlerChange" :placeholder="placeholderStr"/>
